...
String xlPath_tc = "C:/Users/User/Desktop/Work/Project/Result/TC02_Create Requesting Permission/TC02_Create Requesting Permission.xlsx";
String xlPath_ts = "C:/Users/User/Desktop/Work/Project/Result/TC02_Create Requesting Permission/TS02_Create Requesting Permission.xlsx";
String xlPath_td = "C:/Users/User/Desktop/Work/Project/Result/TC02_Create Requesting Permission/TD02_Create Requesting Permission.xlsx";
String xlPath ="C:/Users/User/Desktop/Work/Project/KDF/TC02_Create Requesting Permission.xlsx";
	...
	if(xTCdata[i][4].equalsIgnoreCase('y')){
		...
		for(int j = 1; j < xTDdata.length; j++){
			...
			if(xTDdata[j][1].equalsIgnoreCase('y')){
				...
				CustomKeywords.'webTest.NewKeywords.list_select'(xTSdata[6][5], xTDdata[j][4])
				CustomKeywords.'webTest.NewKeywords.button_click'(xTSdata[7][5])
				...
				try {
					...
					if(actual_text.equals(xTDdata[j][5])){
						xTDdata[j][7] = "Pass"
						   ...
						   xTDdata[j][9] = "TC02_TD"+ j
						   CustomKeywords.'webTest.NewKeywords.Takescreen'("C:/Users/User/Desktop/Work/Project/Result/Capture/TC02_TD"+ j +".png")
					}
				}
				 WebUI.closeBrowser()
			}
