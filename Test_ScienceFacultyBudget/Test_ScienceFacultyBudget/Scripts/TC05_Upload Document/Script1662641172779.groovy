...
String xlPath_tc = "C:/Users/User/Desktop/Work/Project/Result/TC05_Upload Document/TC05_Upload Document.xlsx";
String xlPath_ts = "C:/Users/User/Desktop/Work/Project/Result/TC05_Upload Document/TS05_Upload Document.xlsx";
String xlPath_td = "C:/Users/User/Desktop/Work/Project/Result/TC05_Upload Document/TD05_Upload Document.xlsx";
String xlPath ="C:/Users/User/Desktop/Work/Project/KDF/TC05_Upload Document.xlsx";
	...
	if(xTCdata[i][4].equalsIgnoreCase('y')){
		...
		for(int j = 1; j < xTDdata.length; j++){
			...
			if(xTDdata[j][1].equalsIgnoreCase('y')){
				...
				CustomKeywords.'webTest.NewKeywords.uploadFile'(xTSdata[4][5],xTDdata[j][2])
				...
				try {
					...
					if(actual_text.equals(xTDdata[j][3])){
						xTDdata[j][5] = "Pass"
						   ...
						   xTDdata[j][7] = "TC05_TD"+ j
						   CustomKeywords.'webTest.NewKeywords.Takescreen'("C:/Users/User/Desktop/Work/Project/Result/Capture/TC05_TD"+ j +".png")
					}
				}
				 WebUI.closeBrowser()
			}
