...
String xlPath_tc = "C:/Users/User/Desktop/Work/Project/Result/TC03_Create Travel Request/TC03_Create Travel Request.xlsx";
String xlPath_ts = "C:/Users/User/Desktop/Work/Project/Result/TC03_Create Travel Request/TS03_Create Travel Request.xlsx";
String xlPath_td = "C:/Users/User/Desktop/Work/Project/Result/TC03_Create Travel Request/TD03_Create Travel Request.xlsx";
String xlPath ="C:/Users/User/Desktop/Work/Project/KDF/TC03_Create Travel Request.xlsx";
		...
		for(int j = 1; j < xTDdata.length; j++){
			...
			if(xTDdata[j][1].equalsIgnoreCase('y')){
				...
				try {
					...
					xTDdata[j][7] = actual_text
					if(actual_text.equals(xTDdata[j][6])){
						xTDdata[j][8] = "Pass"
					}else{
						   xTDdata[j][8] = "Fail"
						   xTDdata[j][9] = "- Not Match Expected Result -"
						   xTDdata[j][10] = "TC03_TD"+ j
						   CustomKeywords.'webTest.NewKeywords.Takescreen'("C:/Users/User/Desktop/Work/Project/Result/Capture/TC03_TD"+ j +".png")
					}
				}
				 WebUI.closeBrowser()
			}
